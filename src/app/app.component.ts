...
import { IonApp, IonSplitPane, IonMenu,IonHeader,  IonContent, IonToolbar, IonTabBar, IonTitle,IonTabs, IonAvatar,IonList, IonListHeader, IonNote, IonMenuToggle, IonItem, IonIcon, IonLabel, IonRouterOutlet, IonRouterLink } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [RouterLink, RouterLinkActive, IonApp,IonHeader,IonToolbar, IonTabBar, IonTabs,IonAvatar,IonTitle, IonSplitPane, IonMenu, IonContent, IonList, IonListHeader, IonNote, IonMenuToggle, IonItem, IonIcon, IonLabel, IonRouterLink, IonRouterOutlet],
})
